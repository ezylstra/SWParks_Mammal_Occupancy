...
# we don't have day/effort values on the original scale in model_list$data
...
```{r, code = readLines("src/single-season-models/spOccupancy-predictions.R"), eval = psi_cov_run}
