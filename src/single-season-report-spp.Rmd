...
```{r code = readLines("src/single-season-models/spOccupancy-predictions.R"), include = length(psi_covs) > 0}

```

```{r, include = length(psi_covs) > 0, fig.id = "figure", fig.cap = occmap_cap}
