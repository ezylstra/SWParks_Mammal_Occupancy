...
the `r nrow(occasions)` sampling occasions. The total number of photos containing a mammal during
the annual camera deployment at `r PARKL` has ranged from `r min(dat_park$n)` to `r max(dat_park$n)`.
