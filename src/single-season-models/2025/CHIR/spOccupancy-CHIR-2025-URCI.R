...
# elev in top 5 models
# best model: elev (1.000), roads (0.979), deploy_exp (0.979) all f>0.9, burn not
# 2nd best model: elev (0.999), pois (0.932), deploy_exp (0.977) all f>0.9, burn not
# 3rd best model: elev(0.999), roadbound (0.953), deploy_exp (0.993) all f>0.9, burn not
# going to run these three same models all without burn 
...
# power from the model for occurrence.
  ...
  model_specs
   ...
   # elev (1.000), roads (0.980), deploy_exp (0.988) is best model; all cov f>0.9 AND exclude zero!; good Rhat, ESS, ppc.sites, and ppc.reps
