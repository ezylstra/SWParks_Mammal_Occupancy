...
# only day2 f > 0.9 (0.947), effort close (0.879)
...
# 4 of top 5 models have elev
# All ppc.sites are kind of low, but top model is <0.1 whereas 2nd and 3rd best models are above 0.1 threshold
# Top model: elev (1.000), trail (0.998), and day2 (0.907) f>0.9
# 2nd best: slope (0.955), roadbound (1.000) f>0.9, day2 borderline (0.898)
# 3rd best: elev (0.990), roadbound (0.999) f>0.9, day2 borderline (0.895)
...
# power from the model for occurrence.
 ...
 DET_NULL <- TRUE
  ...
  model_specs
   ...
   # best model elev (1.000), trail (1.000), day (0.568), day2(0.893) -- going to also run this with a null model since day2 is on the cusp
  # The ppc.sites values are >0.1 but very borderline, so going to add REs 
