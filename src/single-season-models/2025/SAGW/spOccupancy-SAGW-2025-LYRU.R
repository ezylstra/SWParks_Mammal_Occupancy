...
# day2 (~0.968) and deploy_exp (0.903) f>0.9 
...
# model 1 and 3 both have slope and day2 and deploy_exp, best model (#21) has trailpoi and 3rd best (#10) has trail with f>0.9, best has wash > 0.9 as well but wash < 0.9 for 3rd best
# 2nd best model has 4 occ covariates with f>0.9 plus day2 and deploy_exp (very complicated)

# Going to build models with just slope, trailpoi, and wash as occ covariates, slope, trail, and wash, and slope and trail in the next part to compare which is better 
# New best model is still slope, trailpoi, wash, but not wash f<0.9
# Going to compare slope trail vs slope trailpoi
...
# power from the model for occurrence.
  ...
  OCC_NULL <- FALSE
  OCC_MODELS <- list(c("slope", "trailpoi", "wash"),
                     c("slope", "trail", "wash"),
                      c("slope", "trail"))
