...
# only day2 f>0.9, but effort close 
# try another model with just effort and day2
...
# top 3 models = 12, 15, 1
# 12: north, poi, veg, day2 are f>0.9
#15: poi, veg, day2 are f>0.9
#1: north, roads, veg, day2 are f>0.9
# All models have acceptable Rhat, ESS, ppc.sites, and ppc.reps, but model 15 ppc.sites and ppc.reps are a bit higher
...
# power from the model for occurrence.
  ...
  OCC_NULL <- FALSE
  OCC_MODELS <- list(c("north", "pois", "veg"),
                     c("pois", "veg"),
                     c("north", "roads", "veg"))
