...
# model 15: poi (0.997), veg3 (0.913), deploy_exp (0.901), effort (0.938) f > 0.9
#13: poi (0.990), deploy_exp (0.901), effort (0.937)f > 0.9
#14: poi (0.993), deploy_exp (0.912), effort (0.930) f > 0.9

# going to try poi + veg, poi + wash, poi combos for occ
...
# power from the model for occurrence.
  ...
  # Look at model output and f values
   ...
   # best model poi + deploy_exp + effort
# View trace plots
