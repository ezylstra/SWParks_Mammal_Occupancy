...
# day and day2 f>0.9 but day (0.965) stronger than day2 (0.907); going to include day2 
...
# best model (#10) ~slope (0.995) + trail (0.998) ~day (0.956) + day2 (0.906); acceptable Rhat, ESS, ppc.sites, and ppc.reps
