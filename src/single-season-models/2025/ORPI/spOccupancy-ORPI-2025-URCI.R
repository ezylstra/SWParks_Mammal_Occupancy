...
# slope in top 6 models
# best model (#10) ~slope (0.999) + trail (0.991) ~day (0.974) + day2 (0.936) + effort (0.933); Rhat, ESS, ppc.sites, ppc.reps, all acceptable
