...
## Can't get a good model to run that passes PPC (can't get ppc.reps > 0.1 even with random effects)
...
# Can't get PPC.reps above 0.1, even with random effects
...
DET_MODELS <- list(c("day2", "effort"), c("day", "effort"), "day", "day2", "effort") 
