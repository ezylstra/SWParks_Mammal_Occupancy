...
```{r tab-estimates, ft.align = "left", tab.id = "table"}
...
```{r CALA-test-marginal-psi1, fig.id = "figure", fig.cap = marg_cap}

marg_cap <- paste0("Effect of XXX on occurrence probabilities for ", spp_plural,
                   " in ", PARKL, ", ", YEAR, ".")
