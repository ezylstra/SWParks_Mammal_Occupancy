################################################################################
# Prep data (including all potential covariates) for a single-season occupancy
# analysis for a given species, park, and year

# Script is typically called from SSoccupancy-wrapper.R
