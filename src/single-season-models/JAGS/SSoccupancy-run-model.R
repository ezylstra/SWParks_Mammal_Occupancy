################################################################################
# Extract covariates and run a single-season model in JAGS

# Script is typically called from SSoccupancy-wrapper.R (which has already
# sourced SSoccupancy-prep-data.R)
