################################################################################
# Prep data (including all potential covariates) for a multi-season occupancy
# analysis for a given species, park, and sequence of years

# Script is typically called from MSoccupancy-wrapper.R
