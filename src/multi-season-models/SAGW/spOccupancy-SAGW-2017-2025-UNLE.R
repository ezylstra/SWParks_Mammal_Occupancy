...
BEST_ANNUAL <- "monsoon_vpd"
# monsoon_ppt also very close
...
# power from the model for occurrence.
  ...
  OCC_MODELS <- list(c("slope", "wash"), c("slope", "wash", "monsoon_vpd"), 
                     c("slope", "trail", "wash"), c("slope", "wash", "trail", "monsoon_vpd"))
