################################################################################
# Occurrence models for Mule deer in SAGW, 2017-2022
...
# Models with 10-month precipitation (ppt10) better than the rest
# Trend model is the worst (and coefficient is ~0)
BEST_ANNUAL <- "ppt10"

# For detection covariates: multiple coefficients are significant. Will keep
# the full model
...
# No. Elevation isn't close to significant. Vegclasses/wash isn't techinally
# significant, but having only boundary in the model isn't great, so we'll 
# keep this in.

scov_new <- list(c("boundary", "veg", "wash"))
