...
BEST_ANNUAL <- "ppt10"
# ppt10 is better model by far (delta WAIC > 7). Years model has no support.
# Estimated trend is negative but does overlap zero.
...
# for occurrence.
  ...
  scov_new <- list(c("slope", "boundary", "veg"),
                   c("slope", "boundary"),
                   c("slope", "veg"),
                   c("slope"),
                   c("east", "pois"),
