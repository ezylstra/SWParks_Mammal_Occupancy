################################################################################
# Occurrence models for Black-tailed jackrabbits in SAGW, 2017-2022
...
# Trend model is considerably better than other models
BEST_ANNUAL <- "years"

# For detection covariates: effort is close to significant. Maybe the quadratic
# day term, but for now we'll stick with just effort.
...
# Can view these plots, calling them by name. Available plots listed here:
  ...
  #                          PARK, "-", SPECIES, "-Occ-slope.jpg"),
  #        plot = marginal_psi_slope,
  #        device = "jpeg",
  #        width = 4,
  #        height = 4,
  #        units = "in",
