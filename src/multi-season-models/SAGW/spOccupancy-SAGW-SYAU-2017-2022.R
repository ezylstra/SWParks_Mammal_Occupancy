...
# For detection covariates: day and deploy_exp are close to significant. Effort
# isn't. 
...
# rm(DET_MODELS2)
DET_MODELS2 <- list(c("day2", "deploy_exp"))
...
# Yes. Everything is at least close to significant (east, pois)
...
# If there are any continuous covariates, create a figure for each:
  ...
  # Could also save any of the plots to file using ggsave()
  # ggsave(filename = paste0("C:/Users/erin/OneDrive/SODN/Mammals/SAGW_20172022_PrelimResults/",
  #                          PARK, "-", SPECIES, "-Det-deploy-exp.jpg"),
  #        plot = marginal_p_deploy_exp,
  #        device = "jpeg",
  #        width = 4,
  #        height = 4,
  #        units = "in",
