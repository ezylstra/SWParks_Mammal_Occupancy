...
#------------------------------------------------------------------------------#
# Create a table with occupancy or detection probabilities in each vegetation 
# class
#------------------------------------------------------------------------------#

# INPUTS
# model: object with output from spOccupancy single-season model
...
#------------------------------------------------------------------------------#
# Create figure depicting marginal effect of a covariate on occurrence 
# probability (predicted covariate effect assuming all other 
...
# RETURNS
# marg_plot: ggplot object depicting marginal effect of covariate on original
# scale
